...
<%@ page import="com.flightmanagement.allflightinfo.model.FlightDetails"%>
<%
    ...
    String cssPath = theme.equals("dark") ? "/allflightinfoservicecss/allflightinfocss/allflightinfodark.css" : "/allflightinfoservicecss/allflightinfocss/allflightinfolight.css";
%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<nav class="navbar">
	...
	<script> 
	    ...
	    window.addEventListener('load', () => {
	        ...
	        if (savedTheme === 'dark') {
	            themeLink.setAttribute('href', '/allflightinfoservicecss/allflightinfocss/allflightinfodark.css');
	            lightIcon.style.display = 'none';
	            darkIcon.style.display = 'inline';
	        } else {
	            themeLink.setAttribute('href', '/allflightinfoservicecss/allflightinfocss/allflightinfolight.css');
      ...
      function toggleDarkMode() {
    	    ...
    	    const lightTheme = '/allflightinfoservicecss/allflightinfocss/allflightinfolight.css';
    	    const darkTheme = '/allflightinfoservicecss/allflightinfocss/allflightinfodark.css';
