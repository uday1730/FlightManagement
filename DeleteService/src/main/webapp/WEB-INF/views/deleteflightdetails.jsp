...
<%@ page import="com.flightmanagement.deleteflight.model.FlightDetails"%>
<%
    ...
    String cssPath = theme.equals("dark") ? "/deleteclasscss/allflightinfocss/allflightinfodark.css" : "/deleteclasscss/allflightinfocss/allflightinfolight.css";
%>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Delete Flight Details</title>
...
<nav class="navbar">
			<div class="nav-left" onclick="window.location.href='/homePage';">
				<img class="logo" src="/deleteclasscss/allflightinfocss//airplane-mode.png"
	...
	<script> 
		fetch('allflightinfoapi/allFlights')
    	.then(response => {
            if (!response.ok) {
        ...
        .then(flights => {
            ...
            if (!flights || flights.length === 0) {
                ...
                flights.forEach(flight => {
                	console.log("Rendering flight card for ID:", flight.id);
                    	...
                    	<div class="flight-card">
	                        ...
	                        <div class="flight-info-right">
	                            <div class="price-and-book">
	                                ...
	                                <button class="book-button" onclick="submitFlight(\${flight.id})">DELETE</button>
	    ...
	    window.addEventListener('load', () => {
	        ...
	        if (savedTheme === 'dark') {
	            themeLink.setAttribute('href', '/deleteclasscss/allflightinfocss/allflightinfodark.css');
	            lightIcon.style.display = 'none';
	            darkIcon.style.display = 'inline';
	        } else {
	            themeLink.setAttribute('href', '/deleteclasscss/allflightinfocss/allflightinfolight.css');
      ...
      function toggleDarkMode() {
    	    ...
    	    const lightTheme = '/deleteclasscss/allflightinfocss/allflightinfolight.css';
    	    const darkTheme = '/deleteclasscss/allflightinfocss/allflightinfodark.css';
